...
namespace TP_M11_Bernardo_Patrícia
{
    ...
    {
        internal static void VerEnfermeiros(List<Trabalhadores> listaTrabalhadores)
        {
            try
            {
                Console.Clear();
                for (int i = 0; i < listaTrabalhadores.Count; i++)
                {
                    ...
                    if (listaTrabalhadores[i].GetType().ToString().Equals("TP_M11_Bernardo_Patrícia.Enfermeiros"))
